...
export default function NewPostDetailPage() {
  ...
  const inputStyle =
    "h-14 border-none bg-white px-4 text-center text-base font-normal placeholder:text-(--sub-text) shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-xl";
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-(--bg)">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-4">
        {/* 러닝 요약 정보 */}
        <div className="relative flex items-center justify-between rounded-xl bg-(--sub-color) px-4 py-4 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
        ...
        <div className="mt-4">
          ...
          >
            {locations.main ? (
              ...
              <span className="text-base font-normal text-(--sub-text)">
                대표위치 선택
              </span>
            )}
          </button>
        ...
        <div className="mt-4">
          <textarea
            ...
            className="min-h-[120px] w-full resize-none rounded-2xl border-none bg-white px-4 py-3 text-sm text-(--black) placeholder:text-(--sub-text) shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] focus:outline-none focus:ring-2 focus:ring-(--key-color)"
          />
        </div>
      </main>
